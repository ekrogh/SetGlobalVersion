...
namespace SetVersionNumberGloballyXam
{
	public partial class MyToolWindowControl : UserControl
	{
		...
		private async Task<bool> ThisIsXamarinAsync()
		{
		...
		public ProjectType GetProjectType(SolutionItem SlnItem)
		{
		...
		private async System.Threading.Tasks.Task GetShowPathsToAndroidiOSmacOSUWPAsync()
		{
			try
			{
				await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
